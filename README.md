[996.vet](https://996.vet)
=======
* [中文版](./README_CN.md)

[![LICENSE](https://img.shields.io/badge/license-Anti%20996-blue.svg)](https://github.com/996icu/996.ICU/blob/master/LICENSE)

Recently, a vast amount of Chinese Companies announced their working policy: **996**

996 means the daily working hour starts from 9 am, ends at 9 pm, and employee works 6 days a week. However, **996** is just a general name for those companies who require employee work on regulary overtime. Some of them even reqest people work on **007**.
...
-Due to the reason those 996 companies use terms like "volunteer", "dedicate" in order to avoid the legal issue, we are here to collect any evidence of them and help to report it to **Labor and Social Security Bureau**. You can submit your report and evidence here **（https://996.vet)**
